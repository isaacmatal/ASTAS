Public Class Cooperativa_Reparto_Global_ATAF
    Dim Sql As String
    ...
    Private Sub Cooperativa_Reparto_Global_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.dgvRepartos.DataSource = Proc.obtenerDatos(New SqlClient.SqlCommand("EXECUTE sp_INGRESO_PLANILLA_ESPECIAL_AHORROS @COMPAÑIA=" & Compañia & ", @BANDERA=26, @ASOCIACION=2"))
    End Sub
    Public Sub cargarCasosEspeciales()
        dgvCasosEspeciales.DataSource = Proc.ObtenerDataSet("EXECUTE sp_COOPERATIVA_DIVIDENDOS_SOCIOS_ESPECIALES @COMPAÑIA=" & Compañia & ", @BANDERA=10, @MES=" & NumericUpDown10.Value & ",@AÑO=" & NumericUpDown9.Value).Tables(0)
    ...
    Public Sub CargarGrid()
        DataGridView1.DataSource = Proc.ObtenerDataSet("EXECUTE sp_INGRESO_PLANILLA_ESPECIAL_AHORROS @COMPAÑIA=" & Compañia & ", @BANDERA=0, @ASOCIACION=2, @NUMERO_REPARTO=" & NumericUpDown11.Value).Tables(0)
        For i As Integer = 0 To Me.DataGridView1.Columns.Count - 1
            ...
            End If
            Me.DataGridView1.Columns.Item(i).DefaultCellStyle.ForeColor = Color.Black
        Next
    End Sub
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        Me.NumericUpDown11.Value = Proc.obtenerEscalar("SELECT MAX(NUMERO_REPARTO) + 1 FROM COOPERATIVA_DIVIDENDOS_GLOBAL WHERE ASOCIACION = 2")
    ...
    Private Sub Bw1_DoWork_1(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles Bw1.DoWork
        ...
        Proc.Ejecutar_ConsultaSQL("EXECUTE sp_INGRESO_PLANILLA_ESPECIAL_AHORROS @COMPAÑIA=" & Compañia & ", @BANDERA=16, @AÑO='" & NumericUpDown1.Value.ToString() & "',@MES='" & NumericUpDown2.Value.ToString() & "',@AÑO1='" & NumericUpDown4.Value.ToString() & "',@MES1='" & NumericUpDown3.Value.ToString() & "', @USUARIO_CREACION=" & Usuario & ",@USUARIO_EDICION=" & Usuario & ", @ASOCIACION=2,@NUMERO_REPARTO=" & NumericUpDown11.Value)
    ...
    Private Sub aBw1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles aBw1.DoWork
        dataset01 = Proc.ObtenerDataSet("EXECUTE sp_INGRESO_PLANILLA_ESPECIAL_AHORROS @COMPAÑIA=" & Compañia & ", @FECHA_AHORRO='" & "01/" & Me.txtMes.Value & "/" & Me.txtAño.Value.ToString() & "',@BANDERA=23, @ASOCIACION=2,@NUMERO_REPARTO=" & NumericUpDown11.Value)
        'ordinario ASTAS        
    End Sub
    ...
    Private Sub bBw1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles bBw1.DoWork
        ...
        Else
            ...
            Else
                Proc.Ejecutar_ConsultaSQL("EXECUTE sp_INGRESO_PLANILLA_ESPECIAL_AHORROS @BANDERA=17 ,@COMPAÑIA=" & Compañia & ", @AÑO='" & txtAño.Value.ToString() & "', @MES='" & txtMes.Value.ToString() & "', @UTIL_GENER=" & txtUtilidad.Text & ",@FECHA_AHORRO=" & "'01/" & NumericUpDown2.Value.ToString() + "/" + NumericUpDown1.Value.ToString() & "',@FECHA_AHORRO_FINAL='" & "01/" & txtMes.Value.ToString() + "/" + txtAño.Value.ToString() & "',@USUARIO_CREACION='" & Usuario & "',@USUARIO_EDICION='" & Usuario & "', @ASOCIACION=2,@NUMERO_REPARTO=" & NumericUpDown11.Value.ToString())
            End If
        End If
    End Sub
        ...
        Try
            While a_repartir - totalExtra - totalOrdinario > 0.1
                For i As Integer = 0 To Me.DataGridView1.RowCount - 1
                    Proc.Ejecutar_ConsultaSQL("EXECUTE sp_INGRESO_PLANILLA_ESPECIAL_AHORROS @COMPAÑIA=" & Compañia & ", @BANDERA=18, @AÑO='" & DataGridView1.Rows(i).Cells(0).Value.ToString() & "',@MES='" & DataGridView1.Rows(i).Cells(1).Value.ToString() & "',@AÑO1='" & DataGridView1.Rows(i).Cells(0).Value.ToString() & "',@MES1='" & DataGridView1.Rows(i).Cells(1).Value.ToString() & "', @USUARIO_CREACION='" & Usuario & "',@USUARIO_EDICION='" & Usuario & "', @ASOCIACION=2,@NUMERO_REPARTO=" & NumericUpDown11.Value.ToString())
                Next
                dataset02 = Proc.ObtenerDataSet("EXECUTE sp_INGRESO_PLANILLA_ESPECIAL_AHORROS @COMPAÑIA=" & Compañia & ", @BANDERA=24, @USUARIO_CREACION='" & Usuario & "',@USUARIO_EDICION='" & Usuario & "', @ASOCIACION=2,@NUMERO_REPARTO=" & NumericUpDown11.Value.ToString())
                ...
                If a_repartir - totalExtra - totalOrdinario > 0.1 Then
                    For i As Integer = 0 To Me.DataGridView1.RowCount - 1
                        Proc.Ejecutar_ConsultaSQL("EXECUTE sp_INGRESO_PLANILLA_ESPECIAL_AHORROS @COMPAÑIA=" & Compañia & ", @BANDERA=19, @AÑO='" & DataGridView1.Rows(i).Cells(0).Value.ToString() & "',@MES='" & DataGridView1.Rows(i).Cells(1).Value.ToString() & "',@AÑO1='" & DataGridView1.Rows(i).Cells(0).Value.ToString() & "',@MES1='" & DataGridView1.Rows(i).Cells(1).Value.ToString() & "', @USUARIO_CREACION='" & Usuario & "',@USUARIO_EDICION='" & Usuario & "', @ASOCIACION=2,@NUMERO_REPARTO=" & NumericUpDown11.Value)
                    Next
                End If
                ciclo = ciclo + 1
            End While
    ...
    Private Sub eBw1_RunWorkerCompleted(ByVal sender As System.Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles eBw1.RunWorkerCompleted
        ...
        Else
            ...
            MsgBox("FACTOR RECALCULADO, DEBE REPARTIR ORDINARIAMENTE DE NUEVO!")
    ...
    Private Sub cBw1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles cBw1.DoWork
        For i As Integer = 0 To Me.DataGridView1.RowCount - 1
            Proc.Ejecutar_ConsultaSQL("EXECUTE sp_INGRESO_PLANILLA_ESPECIAL_AHORROS @COMPAÑIA=" & Compañia & ", @BANDERA=15, @AÑO='" & DataGridView1.Rows(i).Cells(0).Value.ToString() & "',@MES='" & DataGridView1.Rows(i).Cells(1).Value.ToString() & "',@AÑO1='" & DataGridView1.Rows(i).Cells(0).Value.ToString() & "',@MES1='" & DataGridView1.Rows(i).Cells(1).Value.ToString() & "', @USUARIO_CREACION='" & Usuario & "',@USUARIO_EDICION='" & Usuario & "', @ASOCIACION=2,@NUMERO_REPARTO=" & NumericUpDown11.Value)
        Next
        dataset02 = Proc.ObtenerDataSet("EXECUTE sp_INGRESO_PLANILLA_ESPECIAL_AHORROS @COMPAÑIA=" & Compañia & ", @BANDERA=24, @USUARIO_CREACION='" & Usuario & "',@USUARIO_EDICION='" & Usuario & "', @ASOCIACION=2,@NUMERO_REPARTO=" & NumericUpDown11.Value.ToString())
    End Sub
    ...
    Private Sub Button10_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button10.Click
        ...
        If respuesta = MsgBoxResult.Yes Then
            For i As Integer = 0 To Me.DataGridView1.RowCount - 1
                Proc.Ejecutar_ConsultaSQL("EXECUTE sp_INGRESO_PLANILLA_ESPECIAL_AHORROS @COMPAÑIA=" & Compañia & ", @BANDERA=21, @AÑO='" & DataGridView1.Rows(i).Cells(0).Value.ToString() & "',@MES='" & DataGridView1.Rows(i).Cells(1).Value.ToString() & "',@AÑO1='" & DataGridView1.Rows(i).Cells(0).Value.ToString() & "',@MES1='" & DataGridView1.Rows(i).Cells(1).Value.ToString() & "', @USUARIO_CREACION='" & Usuario & "',@USUARIO_EDICION='" & Usuario & "'")
            Next
            dataset02 = Proc.ObtenerDataSet("EXECUTE sp_INGRESO_PLANILLA_ESPECIAL_AHORROS @COMPAÑIA=" & Compañia & ", @BANDERA=24, @USUARIO_CREACION='" & Usuario & "',@USUARIO_EDICION='" & Usuario & "'")
            'TOTAL EXTRAORDINARIO REPARTIDO PARA ASTAS
            TextBox9.Text = Val(dataset02.Tables(0).Rows(0).Item(0).ToString())
            'TOTAL EXTRAORDINARIO REPARTIDO PARA EJECUTIVOS
            TextBox12.Text = Val(dataset02.Tables(0).Rows(0).Item(2).ToString())
    ...
    Private Sub Button18_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button18.Click
        ...
        For i As Integer = 0 To dgvCasosEspeciales.RowCount - 1
            Try
                'respuesta = MsgBox("¿Desea completar los registros con cuotas 0 para los empleados seleccionados?", MsgBoxStyle.YesNo, "Mensaje de confirmacion")
                'If respuesta = MsgBoxResult.Yes Then
    ...
    Private Sub Button21_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button21.Click
        ...
        If respuesta = MsgBoxResult.Yes Then
            Proc.Ejecutar_ConsultaSQL("EXECUTE sp_INGRESO_PLANILLA_ESPECIAL_AHORROS @BANDERA=25 ,@COMPAÑIA=" & Compañia & ", @AÑO='" & DataGridView1.CurrentRow.Cells.Item(0).Value.ToString() & "', @MES='" & DataGridView1.CurrentRow.Cells.Item(1).Value.ToString() & "', @ASOCIACION=2, @NUMERO_REPARTO=" & NumericUpDown11.Value.ToString())
            CargarGrid()
        End If
    End Sub
    ...
    Private Sub Button22_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button22.Click
        If MsgBox("Está seguro de eliminar el reparto #" & Me.NumericUpDown11.Value, MsgBoxStyle.OkCancel, "Se Eliminarán todos los datos") = MsgBoxResult.Ok Then
            Sql = "DELETE FROM [dbo].[COOPERATIVA_DETALLE_DIVIDENDOS_POR_SOCIO_EXT] WHERE NUMERO_REPARTO = " & Me.NumericUpDown11.Value & " and ASOCIACION = 2" & vbCrLf
            Sql &= "DELETE FROM [dbo].[COOPERATIVA_DETALLE_DIVIDENDOS_POR_SOCIO] WHERE NUMERO_REPARTO = " & Me.NumericUpDown11.Value & " and ASOCIACION = 2" & vbCrLf
            Sql &= "DELETE FROM [dbo].[COOPERATIVA_DIVIDENDOS_CONSTANTES] WHERE NUMERO_REPARTO = " & Me.NumericUpDown11.Value & " and ASOCIACION = 2" & vbCrLf
            Sql &= "DELETE FROM [dbo].[COOPERATIVA_DIVIDENDOS_GLOBAL] WHERE ASOCIACION = 2 AND NUMERO_REPARTO = " & Me.NumericUpDown11.Value & vbCrLf
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        Try
            ...
            fecha2 = jClass.obtenerEscalar("select MAX(FECHA_2) from [dbo].[COOPERATIVA_DETALLE_DIVIDENDOS_POR_SOCIO] where NUMERO_REPARTO = " & Me.NumericUpDown11.Value.ToString & " and ASOCIACION = 2")
