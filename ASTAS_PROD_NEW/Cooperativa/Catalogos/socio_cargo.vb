...
Public Class socio_cargo
    ...
    Private Sub socio_cargo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Sql = "SELECT SECCION,DESCRIPCION_SECCION FROM COOPERATIVA_CATALOGO_SECCIONES WHERE COMPAÑIA=" & Compañia & " AND DIVISION=" & Me.CmbDivision.SelectedValue & " AND DEPARTAMENTO=" & Me.CmbDepartamento.SelectedValue
    ...
    Private Sub LlenarTabla(ByVal Division As Integer, ByVal Departamento As Integer, ByVal Seccion As Integer)
        Me.DGV_Datos.DataSource = Proc.ejecutaSQLl_llenaDTABLE("EXECUTE dbo.sp_COOPERATIVA_CATALOGO_DIVISIONES_DEPARTAMENTO_SECCION_CARGOS_SIUD " & Compañia & ", " & Division & ", " & Departamento & ", " & Seccion & " , " & 0 & " , 'X', '" & Usuario & "', 'S'")
        ...
        Me.DGV_Datos.Columns.Item(5).Width = 330 'Descripción
    End Sub
    ...
    Private Sub BtnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAgregar.Click
        If Me.TxtDivision.Text.Trim > "" Then
            If MsgBox("Esta correcto y actualizar la base de datos", MsgBoxStyle.YesNo, "Adicionar/Modficar") = MsgBoxResult.Yes Then
                ...
                sqlCmd = New SqlCommand("EXECUTE dbo.sp_COOPERATIVA_CATALOGO_DIVISIONES_DEPARTAMENTO_SECCION_CARGOS_SIUD " & Compañia & ", " & Me.CmbDivision.SelectedValue & ", " & Me.CmbDepartamento.SelectedValue & ", " & Me.CmbSeccion.SelectedValue & ", " & Val(Me.TxtCodigo.Text) & ", '" & Me.TxtDivision.Text & "', '" & Usuario & "', '" & Bandera & "'")
    ...
    Private Sub BtnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnEliminar.Click
        If MsgBox("Esta correcto y desea eliminar registro de la base de datos", MsgBoxStyle.YesNo, "Eliminar") = MsgBoxResult.Yes Then
            sqlCmd = New SqlCommand("EXECUTE dbo.sp_COOPERATIVA_CATALOGO_DIVISIONES_DEPARTAMENTO_SECCION_CARGOS_SIUD " & Compañia & ", " & Me.CmbDivision.SelectedValue & ", " & Me.CmbDepartamento.SelectedValue & ", " & Me.CmbSeccion.SelectedValue & ", " & Val(Me.TxtCodigo.Text) & ", '" & Me.TxtDivision.Text & "', '" & Usuario & "', 'D'")
            Dim Resulta As Integer = Proc.ejecutarComandoSql(sqlCmd)
            If Resulta > 0 Then
