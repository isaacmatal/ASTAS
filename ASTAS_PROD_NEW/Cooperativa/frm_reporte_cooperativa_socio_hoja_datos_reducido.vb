...
Public Class frm_reporte_cooperativa_socio_hoja_datos_reducido
    ...
    Private Sub frm_reporte_cooperativa_socio_hoja_datos_reducido_HandleDestroyed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.HandleDestroyed
        If Solicitudes <> Nothing Then
            EliminaSolicitudesTemporales()
        End If
    End Sub

    Private Sub frm_reporte_cooperativa_socio_hoja_datos_reducido_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub Reporte(ByVal CodBux As Integer, ByVal CodAS As String)
        Dim Rpt As New rpt_reporte_cooperativa_socio_hoja_datos_reducido
    ...
    Private Sub frm_reporte_cooperativa_socio_hoja_datos_reducido_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
    ...
    Private Sub frm_reporte_cooperativa_socio_hoja_datos_reducido_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
