...
Public Class Socio_Retiro_FI_V2
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_COD_BUXIS() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSocio_Retiro_FI_V2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Socio_Retiro_FI_V2 = New Socio_Retiro_FI_V2
        rpt.Site = Me.Site
        Return rpt
    End Function
