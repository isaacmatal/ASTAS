...
Public Class Contabilidad_OC_Directa
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Contabilidad_OC_Directa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedContabilidad_OC_Directa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Contabilidad_OC_Directa = New Contabilidad_OC_Directa
        rpt.Site = Me.Site
        Return rpt
    End Function
