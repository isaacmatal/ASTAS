...
Public Class Contabilidad_Procesos
    ...
    'Public Sub Contabiliza_Partida_Automatica_Standard(ByVal Compañia, ByVal CentroCosto, ByVal TipoDocumento, ByVal Origen, ByVal NumeroDocumento, _
    'ByVal FechaContable, ByVal CuentaBanco, ByVal DocumentoAsociado, ByVal Total, ByVal Concepto)
    ...
    '        If res > 0 Then
    '            MsgBox("¡Operación contabilizada con éxito!", MsgBoxStyle.Information, "Mensaje")
    '        Else
    '            MsgBox("¡Ocurrió un problema al momento de contabilizar la operación, revise!", MsgBoxStyle.Exclamation, "Mensaje")
    '        End If
    '        Conexion_.Close()
    ...
    '    End Try
    'End Sub
    Public Function Contabiliza_Partida_Automatica_Standard(ByVal Compañia, _
                                                            ByVal CentroCosto, _
                                                            ByVal TipoDocumento, _
                                                            ByVal Origen, _
                                                            ByVal NumeroDocumento, _
                                                            ByVal FechaContable, _
                                                            ByVal CuentaBanco, _
                                                            ByVal DocumentoAsociado, _
                                                            ByVal Total, _
                                                            ByVal Concepto) As Integer
        Dim res As Integer = 0
    ...
    '    Try
    '        Conexion_.Open()
    '        Sql = "Execute sp_CONTABILIDAD_PARTIDAS_AUTOMATICAS_CONTABILIZAR_COMPRAS "
    '        Sql &= Compañia
    '        Sql &= " ," & CC
    '        Sql &= " ," & TipoDocumento
    '        Sql &= " ," & Origen
    ...
    Public Sub DetallePartida(ByVal Transaccion As Integer, ByVal Linea As Integer, _
                                ByVal CentCost As String, ByVal Fecha As DateTime, ByVal Libro As Integer, _
