...
Public Class Inventario_Reporte_ES_Rotacion
    ...
    Public report_show_ As New Inventario_Reporte_ES_Rotacion_Show

    Private Sub Inventario_Reporte_ES_Rotacion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub loadProductos(ByVal clear_ As Boolean, ByVal descrip_ As String)
        Try
            ...
            Dim Tabla As DataTable
            Dim sqlCmd As New SqlCommand
            sqlCmd.CommandText = "Exec dbo.SP_ANALISIS_ROTACION_INVENTARIOS @BANDERA=2, @COMPAÑIA=1, @BODEGAS='', @GRUPOS='" & Me.grupos_ & "', @SUBGRUPOS='" & Me.subgrupos_ & "', @EXISTENCIA=1 " & parameter_
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(ByVal sender As System.Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        ...
        Try
            If MsgBox("Desea exportar el reporte directamente a Excel?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Mensaje") = MsgBoxResult.Yes Then
                ...
                Rpt.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.Excel, My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\ReporteAnalizarInventarios.xls")
