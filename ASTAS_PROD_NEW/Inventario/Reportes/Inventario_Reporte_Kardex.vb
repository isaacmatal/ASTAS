...
Public Class Inventario_Reporte_Kardex
    ...
    Private Sub Inventario_Reporte_Kardex_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Iniciando = True
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        If MsgBox("¿Está seguro(a) que desea emitir el reporte?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Mensaje") = MsgBoxResult.Yes Then
            If (CDate(Me.txtFechaI.Value) <= CDate(Me.txtFechaF.Value)) Then
                Rpts.CargaInventario_Kardex(Compañia, Me.cmbBODEGA.SelectedValue, Val(Me.txtProducto1.Text), Val(Me.txtProducto2.Text), Me.txtFechaI.Value, Me.txtFechaF.Value)
                If Hay_Datos Then
                    Rpts.ShowDialog()
                End If
            Else
                MsgBox("Fecha Inicial debe ser menor o igual que la final.", MsgBoxStyle.Critical, "AVISO")
                Me.txtFechaI.Focus()
            End If
        End If
    End Sub
