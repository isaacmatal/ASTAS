...
Public Class Inventario_Reporte_Existencias
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        Try
            If Chk_sin_grupos_subgrupos.Checked = True Then
                Dim rpt As New frmReportes_Ver(Compañia, Me.cmbBODEGA.SelectedValue, Me.fecha_hasta.Value, 2, 0, 0, 0, Me.ChkExist_Cero.Checked)
                rpt.ShowDialog()
            Else
                Dim rpt As New frmReportes_Ver(Compañia, Me.cmbBODEGA.SelectedValue, Me.fecha_hasta.Value, 51, 0, 0, 0, Me.ChkExist_Cero.Checked, Me.cmbGRUPO.SelectedValue, Me.cmbSUBGRUPO.SelectedValue)
                rpt.ShowDialog()
            End If            
    ...
    Private Sub Inventario_Reporte_Existencias_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles MyBase.Paint
