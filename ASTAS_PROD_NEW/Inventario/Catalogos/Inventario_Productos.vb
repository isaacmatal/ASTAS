...
Public Class Inventario_Productos
    ...
    End Sub
    Public Sub tipo_bodega()
        Sql = "SELECT GRUPO_BODEGA FROM INVENTARIOS_CATALOGO_BODEGAS WHERE COMPAÑIA=" & Compañia & " AND BODEGA=" & cmbBODEGA.SelectedValue

        Tipo = c_data2.leerDataeader(Sql, 0)
        ...
        ElseIf Tipo = 2 Then
            cmbTipoBodega.SelectedIndex = 2
        ElseIf Tipo = 3 Then
            cmbTipoBodega.SelectedIndex = 3
        End If
    End Sub
    ...
    Private Sub CargaUMC(ByVal Compañia, ByVal Bandera)
        Dim TableUC As DataTable
        Try
            Sql = "Execute sp_INVENTARIOS_CATALOGO_UNIDAD_MEDIDA "
            Sql &= Compañia
            Sql &= ", " & Bandera
            TableUC = c_data2.obtenerDatos(New SqlCommand(Sql))

            Me.cmbUnidadCompra.DataSource = TableUC
            Me.cmbUnidadCompra.ValueMember = "Unidad Medida"
            Me.cmbUnidadCompra.DisplayMember = "Descripción Unidad"
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "AVISO")
        End Try
    End Sub

    Private Sub CargaTipoCosto(ByVal Compañia, ByVal Bandera)
        Dim Table As DataTable
        Try
            ...
            Sql &= ", " & Bandera
            Table = c_data2.obtenerDatos(New SqlCommand(Sql))
            Me.cmbTIPO_COSTO.DataSource = Table
            Me.cmbTIPO_COSTO.ValueMember = "Tipo Costo"
            Me.cmbTIPO_COSTO.DisplayMember = "Descripción"
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "AVISO")
        End Try
    End Sub
    ...
    Private Sub LimpiaGridProductosBodega()
        ...
        Me.dgvProductosBodega.Columns(4).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.dgvProductosBodega.Columns(5).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        Me.dgvProductosBodega.Columns(6).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
    End Sub
    ...
    Private Sub CargaProductos(ByVal Compañia, ByVal Grupo, ByVal SubGrupo, ByVal DescripcionProducto, ByVal Bandera)
        Try
            ...
            Sql &= ", " & Bandera
            Table3 = c_data2.obtenerDatos(New SqlCommand(Sql))
    ...
    Private Sub CargaProductosBodega(ByVal Compañia, ByVal Bodega, ByVal Prod, ByVal DescripcionProducto, ByVal Grupo, ByVal Bandera)
        Try
            ...
            Sql &= ", " & Grupo
            Sql &= ", " & Bandera
            Table2 = c_data2.obtenerDatos(New SqlCommand(Sql))
    ...
    ByVal UnidadMedida, ByVal UnidadCompra, ByVal UMLIbra, ByVal Servicio, ByVal Stock, ByVal TipoCosto, ByVal Margen, ByVal IUD, ByVal promocion, ByVal _factor)
        Dim si_no As String
        Try
    ...
    Private Sub Mantenimiento_ProductoBodega(ByVal Compañia, ByVal Bodega, ByVal CodProducto, ByVal IUD)
        ...
        'SE DETERMINAN LAS BODEGAS SEGUN EL TIPO; CAFETERIA, ALMACEN O DESPENSA
        If cmbTipoBodega.SelectedItem = "Otros" Then
            tabla = c_data2.ejecutaSQLl_llenaDTABLE("SELECT BODEGA FROM INVENTARIOS_CATALOGO_BODEGAS WHERE COMPAÑIA=" & Compañia & " AND GRUPO_BODEGA=" & 0)
        ElseIf cmbTipoBodega.SelectedItem = "Almacen" Then
            tabla = c_data2.ejecutaSQLl_llenaDTABLE("SELECT BODEGA FROM INVENTARIOS_CATALOGO_BODEGAS WHERE COMPAÑIA=" & Compañia & " AND  GRUPO_BODEGA=" & 1)
        ...
        ElseIf cmbTipoBodega.SelectedItem = "Despensa" Then
            tabla = c_data2.ejecutaSQLl_llenaDTABLE("SELECT BODEGA FROM INVENTARIOS_CATALOGO_BODEGAS WHERE COMPAÑIA=" & Compañia & " AND  GRUPO_BODEGA=" & 3)
        End If
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        If ValidaCampos() = True Then
            If Actualizar = False Then
                ...
                Trim(Me.txtDESCRIPCION_PRODUCTO.Text.Replace("'", "")), Me.cmbUNIDAD_MEDIDA.SelectedValue, Me.cmbUnidadCompra.SelectedValue, IIf(Me.rbtnLIBRA_SI.Checked = True, "1", "0"), IIf(Me.chkSERVICIO.Checked = True, "1", "0"), IIf(Me.chkNoStock.Checked = True, "0", "1"), Me.cmbTIPO_COSTO.SelectedValue, Val(Me.txtMARGEN.Text), "I", intPromocion, Me.txtFactorConversion.Text)
            Else
                Mantenimiento_Producto(Compañia, Me.lblPRODUCTO.Text.PadLeft(4, "0"), Me.cmbGRUPO.SelectedValue, Me.cmbSUBGRUPO.SelectedValue, Val(Me.txtPRODUCTO_ANTERIOR.Text), _
                Trim(Me.txtDESCRIPCION_PRODUCTO.Text.Replace("'", "")), Me.cmbUNIDAD_MEDIDA.SelectedValue, Me.cmbUnidadCompra.SelectedValue, IIf(Me.rbtnLIBRA_SI.Checked = True, "1", "0"), IIf(Me.chkSERVICIO.Checked = True, "1", "0"), IIf(Me.chkNoStock.Checked = True, "0", "1"), Me.cmbTIPO_COSTO.SelectedValue, Val(Me.txtMARGEN.Text), "U", intPromocion, Me.txtFactorConversion.Text)
                lblPRODUCTO.Enabled = True
                Actualizar = False
            End If
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        If Trim(Me.lblPRODUCTO.Text) <> "" Then
            If MsgBox("¿Está seguro(a) que desea eliminar el Producto seleccionado?" & Chr(13) & _
                ...
                Trim(Me.txtDESCRIPCION_PRODUCTO.Text), Me.cmbUNIDAD_MEDIDA.SelectedValue, Me.cmbUnidadCompra.SelectedValue, IIf(Me.rbtnLIBRA_SI.Checked = True, "1", "0"), IIf(Me.chkSERVICIO.Checked = True, "1", "0"), IIf(Me.chkNoStock.Checked = True, "0", "1"), Me.cmbTIPO_COSTO.SelectedValue, Val(Me.txtMARGEN.Text), "D", intPromocion, Me.txtFactorConversion.Text)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            If (Me.TXT_CODIGO.Text <> "" And Me.TXT_DESCRIPCION.Text = "") Then
                CargaProductosBodegaBusquedasAvanz(Compañia, Me.cmbBODEGA.SelectedValue, Me.TXT_CODIGO.Text, Me.TXT_DESCRIPCION.Text, Me.hab_busqueda.Checked.ToString(), 1)
            End If
            If (Me.TXT_CODIGO.Text = "" And Me.TXT_DESCRIPCION.Text <> "") Then
                CargaProductosBodegaBusquedasAvanz(Compañia, Me.cmbBODEGA.SelectedValue, 0, Me.TXT_DESCRIPCION.Text, Me.hab_busqueda.Checked.ToString(), 2)
            End If
            If (Me.TXT_CODIGO.Text <> "" And Me.TXT_DESCRIPCION.Text <> "") Then
                CargaProductosBodegaBusquedasAvanz(Compañia, Me.cmbBODEGA.SelectedValue, Me.TXT_CODIGO.Text, Me.TXT_DESCRIPCION.Text, Me.hab_busqueda.Checked.ToString(), 5)
            End If
            If (Me.TXT_CODIGO.Text = "" And Me.TXT_DESCRIPCION.Text = "") Then
    ...
    Private Sub dgvProductos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dgvProductos.Click
        ...
        Me.cmbUnidadCompra.SelectedValue = Me.dgvProductos.CurrentRow.Cells.Item(18).Value
        Me.txtFactorConversion.Text = Me.dgvProductos.CurrentRow.Cells.Item(19).Value
    ...
    Private Sub chkPromocion_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkPromocion.CheckedChanged
        If chkPromocion.Checked = True Then
            MessageBox.Show("El producto sera considerado como promocion...", "ASTAS", MessageBoxButtons.OK, MessageBoxIcon.Information)
            intPromocion = 1
        Else
            intPromocion = 0
        End If
