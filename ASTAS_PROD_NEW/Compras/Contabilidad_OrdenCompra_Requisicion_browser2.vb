...
Public Class Contabilidad_OrdenCompra_Requisicion_browser2
    ...
    Private Sub Contabilidad_OrdenCompra_Requisicion_browser2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub crearGrid()
        If Me._puede_procesar Then
            ...
            gvRequisiciones.Columns(1).HeaderText = "Requisición"
            gvRequisiciones.Columns(1).Width = 70
            gvRequisiciones.Columns(2).HeaderText = "Creada"
            gvRequisiciones.Columns(2).Width = 80
            gvRequisiciones.Columns(3).HeaderText = "Solicitada"
            ...
            gvRequisiciones.Columns(6).Width = 100
            gvRequisiciones.Columns(7).HeaderText = "Creo"
            gvRequisiciones.Columns(7).Width = 80
            gvRequisiciones.Columns(8).HeaderText = "Modifico"
            gvRequisiciones.Columns(8).Width = 80
            gvRequisiciones.Columns(9).HeaderText = "Fecha Modifico"
            gvRequisiciones.Columns(9).Width = 80
            gvRequisiciones.Columns(10).HeaderText = "O.C."
            gvRequisiciones.Columns(10).Width = 200
        Else
            gvRequisiciones.Columns(0).HeaderText = "Estatus"
            gvRequisiciones.Columns(0).Width = 90
            gvRequisiciones.Columns(1).HeaderText = "Requisición"
            ...
            gvRequisiciones.Columns(5).Width = 100
            gvRequisiciones.Columns(6).HeaderText = "Creo"
            gvRequisiciones.Columns(6).Width = 80
            gvRequisiciones.Columns(7).HeaderText = "Modifico"
            gvRequisiciones.Columns(7).Width = 80
            gvRequisiciones.Columns(8).HeaderText = "Fecha Modifico"
            gvRequisiciones.Columns(8).Width = 80
            gvRequisiciones.Columns(9).HeaderText = "O.C."
            gvRequisiciones.Columns(9).Width = 200
        End If
    End Sub
    ...
    Private Sub cargarGrid()
        ...
        If Me._puede_procesar Then            
            ...
            _consulta_general &= " WHERE AFECTAR_INVENTARIO = 0 AND COMPAÑIA = " & Compañia
        Else
            _consulta_general = "SELECT (SELECT DESCRIPCION FROM dbo.CONTABILIDAD_ORDEN_ESTATUS WHERE ESTATUS=R.ESTATUS) As ESTATUS"
            _consulta_general &= ",REQUISICION,FECHA_CREACION,FECHA_SOLICITA"
            _consulta_general &= ",(SELECT DESCRIPCION_BODEGA FROM dbo.INVENTARIOS_CATALOGO_BODEGAS WHERE BODEGA=R.BODEGA AND COMPAÑIA = " & Compañia & ") AS DESCRIPCION_BODEGA"
    ...
    Private Sub Contabilidad_OrdenCompra_Requisicion_browser2_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles MyBase.Paint
    ...
    Private Sub Contabilidad_OrdenCompra_Requisicion_browser2_Activated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Activated
        Me.paintByStatus()
    End Sub
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        _requisicion.afectan_inventario = False
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        If Me._codigo > 0 Then
            If Me._status.Equals("PENDIENTE") Then
                ...
                Me.cargarGrid()
            Else
                MsgBox("Solo puede borrar un documento Pendiente...", MsgBoxStyle.Critical, "Sistema")
            End If
            Me.paintByStatus()
        Else
            MsgBox("Seleccione un Registro...", MsgBoxStyle.Information, "Sistema")
