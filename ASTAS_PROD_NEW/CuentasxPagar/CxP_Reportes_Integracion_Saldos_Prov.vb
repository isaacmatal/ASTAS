...
Public Class CxP_Reportes_Integracion_Saldos_Prov
    Dim Rpts As New frmReportes_Ver
    Dim jClass As New jarsClass
    Dim sqlCmd As New SqlCommand
    Dim Table, tblProv As DataTable
    Dim Sql As String
    Dim rpt As New CuentasxPagar_Integracion_Saldos_Proveedores_rpt
    Dim Iniciando As Boolean

    Private Sub CxP_Reportes_Integracion_Saldos_Prov_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        TextObj.Text = "INTEGRACION DE SALDO " & jClass.obtenerEscalar("SELECT dbo.fn_INVENTARIOS_PERIODO_SEGUN_FECHA ('" & Format(Me.dpFechaI.Value, "dd-MM-yyyy") & "', '" & Format(Me.dpFechaF.Value, "dd-MM-yyyy") & "')")
    ...
    Private Sub CxP_Reportes_Integracion_Saldos_Prov_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
