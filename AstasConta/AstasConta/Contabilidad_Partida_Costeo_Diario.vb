    ...
    Private Sub Partida_Contable()
        ...
        Try
            ...
            If ValidaCierreContable(Compañia, Libro, Me.dpFechaContable.Value.Year, Me.dpFechaContable.Value.Month, "E") Then
                Sql = "EXECUTE [sp_INVENTARIOS_MOVIMIENTO_SIUD] @COMPAÑIA = " & Compañia & ", @BODEGA = " & Me.cmbBodega.SelectedValue & ", @FECHA_MOVIMIENTO = '" & Me.dpFechaContable.Text & "', @SIUD = 'COSTEOXBODEGA'"
