...
Public Class Seguridad_Mantenimiento_Incidencias
    ...
    End Sub
    Function ExtraerImagen1(ByVal Foto As Integer) As Byte()
        Dim SqlSelect As String = "Select IMAGEN1 From SEGURIDAD_INCIDENCIAS_IMAGENES Where ITEM = " & Foto
        OpenConnection()
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            ...
            Dim ms As New MemoryStream(ExtraerImagen1(CInt(Me.TextBox9.Text)))
            Me.PictureBox1.Image = Image.FromStream(ms)
            ms.Close()

            'El MemoryStream nos permite crear un almacen de memoria..
            Dim ms1 As New MemoryStream(ExtraerImagen1(CInt(Me.TextBox9.Text)))
            Me.PictureBox2.Image = Image.FromStream(ms1)
            ms1.Close()

            'El MemoryStream nos permite crear un almacen de memoria..
            Dim ms2 As New MemoryStream(ExtraerImagen1(CInt(Me.TextBox9.Text)))
            Me.PictureBox3.Image = Image.FromStream(ms2)
            ms2.Close()

            'El MemoryStream nos permite crear un almacen de memoria..
            Dim ms3 As New MemoryStream(ExtraerImagen1(CInt(Me.TextBox9.Text)))
            Me.PictureBox4.Image = Image.FromStream(ms3)
            ms3.Close()

            'El MemoryStream nos permite crear un almacen de memoria..
            Dim ms4 As New MemoryStream(ExtraerImagen1(CInt(Me.TextBox9.Text)))
