...
Public Class Seguridad_Accesos
    ...
    Private Sub CargaModulos(ByVal Compañia, ByVal Bandera)
        ...
        Try
            Conexion_.Open()
            Sql = "Execute sp_SEGURIDAD_CATALOGO_MODULOS " & Compañia & ", " & Bandera & ", 1"
            Comando_ = New SqlCommand(Sql, Conexion_)
            DataAdapter_ = New SqlDataAdapter(Comando_)
            Table = New DataTable("Datos")
            DataAdapter_.Fill(Table)
    ...
    Private Sub CargaSubModulos(ByVal Compañia, ByVal Modulo, ByVal Bandera)
        ...
        Try
            Conexion_.Open()
            Sql = "Execute sp_SEGURIDAD_CATALOGO_SUBMODULOS " & Compañia & ", " & Modulo & ", " & Bandera & ", 1"
            Comando_ = New SqlCommand(Sql, Conexion_)
            DataAdapter_ = New SqlDataAdapter(Comando_)
            Table = New DataTable("Datos")
            DataAdapter_.Fill(Table)
    ...
    Private Sub CargaOpciones(ByVal Compañia, ByVal Modulo, ByVal SubModulo, ByVal Bandera)
        ...
        Try
            Conexion_.Open()
            Sql = "Execute sp_SEGURIDAD_CATALOGO_OPCIONES " & Compañia & ", " & Modulo & ", " & SubModulo & ", " & Bandera & ", 1"
            Comando_ = New SqlCommand(Sql, Conexion_)
            DataAdapter_ = New SqlDataAdapter(Comando_)
            Table = New DataTable("Datos")
            DataAdapter_.Fill(Table)
...
#End Region
    ...
    Private Sub Seguridad_Accesos_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
