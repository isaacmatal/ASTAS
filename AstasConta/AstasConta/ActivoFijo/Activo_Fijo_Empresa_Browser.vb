Public Class Activo_Fijo_Empresa_Browser
    Dim objEntidad As New EntidadGenerica
    Dim _form As New Activo_Fijo_Empresa

    Private Sub Activo_Fijo_Empresa_Browser_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Iniciando = True
    ...
    Public Sub fillData()
        objEntidad.entidad_ = "dbo.CONTABILIDAD_ACTIVO_FIJO_EMPRESA"
        objEntidad.fields_ = "EMPRESA, NOMBRE_EMPRESA As ""Nombre de la Empresa"" "
    ...
    Private Sub txtBuscar_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtBuscar.TextChanged
        objEntidad.cadena_ = " SELECT EMPRESA, NOMBRE_EMPRESA As ""Nombre de la Empresa"" FROM dbo.CONTABILIDAD_ACTIVO_FIJO_EMPRESA WHERE COMPAÑIA = " & Compañia & " AND NOMBRE_EMPRESA Like '%" & Me.txtBuscar.Text & "%'"
        dgvConsulta.DataSource = objEntidad.getData()
    End Sub
