Public Class Activo_Fijo_Empresa
    Public codigo_ As Integer
    Public accion_ As String
    Dim objEntidad As New EntidadGenerica
    Public _contenido As String

    Private Sub Activo_Fijo_Empresa_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        If txtDescripcion.Text.Length > 0 Then
            ...
            Select Case accion_
                Case "insert"
                    statement_ = "INSERT INTO dbo.CONTABILIDAD_ACTIVO_FIJO_EMPRESA (NOMBRE_EMPRESA, COMPAÑIA) VALUES ('" & txtDescripcion.Text & "', " & Compañia & ")"
                Case "update"
                    statement_ = "UPDATE dbo.CONTABILIDAD_ACTIVO_FIJO_EMPRESA  SET NOMBRE_EMPRESA = '" & txtDescripcion.Text & "' WHERE COMPAÑIA=" & Compañia & " AND EMPRESA = " & Me.codigo_
                Case "delete"
                    statement_ = "DELETE FROM dbo.CONTABILIDAD_ACTIVO_FIJO_EMPRESA WHERE COMPAÑIA=" & Compañia & " AND EMPRESA = " & Me.codigo_
                Case "select"
                    salvar_ = False
            End Select
