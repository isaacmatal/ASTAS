...
#End Region
    ...
    Private Sub btnVerBC_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVerBC.Click
        ...
        Rpts.CargaBalanceComprobación(Me.cmbCOMPAÑIA.SelectedValue, Me.cmbLIBRO_CONTABLE.SelectedValue, Me.cmbLIBRO_CONTABLE2.SelectedValue, Me.dpFECHA_CONTABLE.Value, 3)
        If Hay_Datos Then
            Rpts.ShowDialog()
        End If
