...
Public Class Contabilidad_Reportes_Resultados_Mes
    Dim Sql As String
    Dim Iniciando As Boolean
    Dim Rpts As New frmReportes_Ver
    Private Sub Contabilidad_Reportes_Resultados_Mes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Iniciando = True
...
#End Region
    ...
    Private Sub btnVerBC_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVerBC.Click
        If MsgBox("¿Está seguro(a) que desea emitir el informe?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Mensaje") = MsgBoxResult.Yes Then
            ...
            Rpts.CargaReporteResultadosMes(Me.cmbCOMPAÑIA.SelectedValue, Me.cmbLIBRO_CONTABLE.SelectedValue, Me.cmbLIBRO_CONTABLE2.SelectedValue, Me.dpFECHA_CONTABLE.Value)
            If Hay_Datos Then
                Rpts.ShowDialog()
            End If
